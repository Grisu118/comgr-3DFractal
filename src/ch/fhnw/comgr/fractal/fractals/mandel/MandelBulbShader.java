...
public class MandelBulbShader extends AbstractShader {
    public MandelBulbShader(Class<?> root, Collection<IAttribute> attributes) {
        ...
        addUniform(new BooleanUniform("shader.vertex_colors_flag", "useVertexColors", () -> false));
        ...
        addUniform(new FloatUniform("mandelbulb.maxDistance", "maxDistance"));
        addUniform(new BooleanUniform("mandelbulb.isColorized", "isColorized"));
